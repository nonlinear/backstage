...
<td>✅ meta</td>
<td>Orchestrator, Business Analyst, Operations Analyst, Librarian</td>
...
> 🔜 Project-specific skills (epic-scoped tools)

---

## Individual Agents

| Agent | Slug | Squad | Domain | Library | Skills | Checks | APIs | Matrix Room |
|-------|------|-------|--------|---------|--------|--------|------|-------------|
...
**Per agent gaps:** See tables (Library topics, Skills, Checks)
