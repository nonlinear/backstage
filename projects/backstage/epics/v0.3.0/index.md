...
flowchart TD
    ...
    click READ_POLICY "https://github.com/nonlinear/backstage/blob/main/global/policies (global/local)" "global/policies (global/local)"
...
- Copy `global/policies (global/local)` + `global/checks (global/local)` → `backstage/global/`
