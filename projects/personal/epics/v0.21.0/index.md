...
### Agent Roles Needed
1. **Business Strategist** - First agent, maps vision/mission/positioning
2. **Legal** - Entity structure, contracts, nonprofit/cooperative law
...
### Agent Communication
- **Drafts first** - Agents prepare proposals, diagrams, reports
- **Questions second** - Targeted questions to Nicholas for direction
...
### Vision & Business
1. What is the vision? Why start this initiative?
2. What services/products will be delivered?
3. Who is the target audience/community?

### No Paywall Implications
1. How to sustain without paywall? (donations, grants, partnerships)
2. Marketing + UX convergence - How to structure without commercial separation?
3. What metrics matter? (engagement, impact, not conversion rates)

### Legal & Structure
1. Entity type? (nonprofit, cooperative, LLC, sole proprietorship)
2. Jurisdiction? (US, Brazil, dual?)
3. Tax implications? (nonprofit status, grant eligibility)

### Agent Orchestration
1. Which agents come first? (business strategist → HR bot → others)
