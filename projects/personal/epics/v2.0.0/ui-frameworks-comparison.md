...
| Framework | Stack | Pros | Cons | Examples |
|-----------|-------|------|------|----------|
| **Next.js + shadcn/ui** | Next.js (React SSG)<br>Tailwind CSS<br>shadcn/ui (copy-paste)<br>gray-matter (YAML)<br>remark (Markdown) | • Modern, widely adopted<br>• No component lock-in (copy-paste)<br>• Static generation (fast)<br>• Great DX (TypeScript, hot reload) | • React learning curve<br>• Build step required | [shadcn/ui](https://ui.shadcn.com/)<br>[Next.js Showcase](https://nextjs.org/showcase)<br>[Taxonomy](https://github.com/shadcn-ui/taxonomy) |
| **Astro + Shoelace** | Astro (content-first)<br>Tailwind CSS<br>Shoelace (Web Components)<br>gray-matter (YAML) | • Minimal JS (0kb default)<br>• Markdown-first (built-in)<br>• Multi-framework support<br>• Fast builds | • Smaller ecosystem<br>• Less familiar to devs | [Astro Themes](https://astro.build/themes/)<br>[Shoelace](https://shoelace.style/)<br>[Astro Repo](https://github.com/withastro/astro) |
| **SvelteKit + DaisyUI** | SvelteKit (Svelte SSG)<br>Tailwind CSS<br>DaisyUI (component classes)<br>gray-matter (YAML) | • Less boilerplate than React<br>• Reactive by default<br>• Semantic class names<br>• Fast runtime | • Smaller community<br>• Fewer ready examples | [DaisyUI](https://daisyui.com/components/)<br>[SvelteKit](https://kit.svelte.dev/)<br>[Kit Repo](https://github.com/sveltejs/kit) |
| **Eleventy + Alpine.js** | Eleventy (static gen)<br>Tailwind CSS<br>Alpine.js (minimal JS)<br>Native Markdown/YAML | • Zero framework overhead<br>• Extremely fast builds<br>• YAML/Markdown native<br>• Optional build step | • Manual routing<br>• Less structure (DIY) | [Eleventy](https://www.11ty.dev/docs/)<br>[Alpine](https://alpinejs.dev/examples)<br>[Base Blog](https://github.com/11ty/eleventy-base-blog) |
| **Plain HTML + Tailwind** | Plain HTML<br>Tailwind CSS (CDN/build)<br>Vanilla JS (fetch/render)<br>No dependencies | • Zero dependencies<br>• Instant load<br>• Full control<br>• Works offline | • Manual everything<br>• No hot reload | [Tailwind CDN](https://tailwindcss.com/docs/installation/play-cdn)<br>[Tailwind Repo](https://github.com/tailwindlabs/tailwindcss) |
...
**Data sources:**
- Official docs (ui.shadcn.com, astro.build, etc.)
