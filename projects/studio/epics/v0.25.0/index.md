...
| Model | Size | llama-cli | llama-server | node-llama-cpp | Ollama |
|-------|------|-----------|--------------|----------------|--------|
| [qwen3.5:27b](https://ollama.com/library/qwen3.5:27b) | 17 GB | *Pending* | *Pending* | *Pending* | *Pending* |
| [qwen2.5:32b](https://ollama.com/library/qwen2.5:32b) | 19 GB | *Pending* | *Pending* | ❌ 12.25 tok/s (crash) | ✅ 23.75 tok/s |
