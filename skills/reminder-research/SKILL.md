...
**🤖 emoji placement:**
- ✅ **ALWAYS in notes** (never in title/task name)
- ❌ Never modify task title
- Update via: `remindctl update <id> --notes "🤖 {result}"`

**Reading context:**
- Consider **task title + notes together** (full context)
- Title = what it is (e.g., "Cheapest iPad mini")
- Notes = instruction/result (e.g., "Second hand, Pencil 2..." → "🤖 Best options...")

**Example:**
```
Title: "Cheapest iPad mini" (unchanged)
Notes BEFORE: "Second hand, Pencil 2, wifi+cellular"
Notes AFTER: "🤖 Best options: Swappa $340, eBay $320..."
```
